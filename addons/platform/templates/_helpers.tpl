{{/*
클러스터 이름. addon Application 이름의 접두사다. 실제 AKS 클러스터명이어야 한다.
*/}}
...
사용: {{ include "platform.staged" (list . "kyverno") }}
*/}}
...
사용: {{- include "platform.meta" (list . "kyverno" "1") | nindent 2 }}
⚠️ 출력이 annotations 맵으로 끝난다. 템플릿에서 이 줄 바로 뒤에 들여쓰기 4칸으로 적은 어노테이션은
   그 맵에 이어진다(compare-options 등).
*/}}
